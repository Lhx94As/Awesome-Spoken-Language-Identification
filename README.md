...
3. [1st WSTC of Interspeech 2020](https://www.microsoft.com/en-us/research/event/workshop-on-speech-technologies-for-code-switching-2020/): A workshop on Speech Technologies for Code-switching in Multilingual Communities.  
## Toolkits:
...
### Acoustic:  
#### i-vector: A common baseline approach. Out of date but worth reading.  
...
#### x-vector: A common baseline approach, developed by Dan's team. (SOTA in some tasks, Embedding+Classifier)
